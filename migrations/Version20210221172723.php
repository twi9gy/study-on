 ...
 */
final class Version20210221172723 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE lesson (id INT NOT NULL, course_id INT NOT NULL, title VARCHAR(255) NOT NULL, content TEXT NOT NULL, number INT DEFAULT NULL, PRIMARY KEY(id))');
